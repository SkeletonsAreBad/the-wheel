...
title @a subtitle ["",{"selector":"@s","color":"dark_red"},{"text":" was jailed for doubting the power of THE WHEEL","color":"red"}]
title @a title ["",{"text":"\u300c","bold":true,"color":"dark_red"},{"text":"THE WHEEL","bold":true,"color":"red"},{"text":"\u300d","bold":true,"color":"dark_red"}]
tellraw @a ["",{"text":"\u300cTHE WHEEL\u300d ","bold":true},{"selector":"@s","color":"dark_red"},{"text":" was jailed for doubting the power of THE WHEEL","color":"red"}]
