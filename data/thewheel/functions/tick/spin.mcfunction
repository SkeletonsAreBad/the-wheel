...
scoreboard players add @e[type=minecraft:armor_stand,tag=thewheel,scores={wheel_anim=1..}] wheel_timer 1
...
execute as @e[type=minecraft:armor_stand,tag=thewheel,scores={wheel_anim=17,wheel_timer=101..}] at @s run setblock ~ ~ ~ minecraft:stone_button[face=floor,powered=false]
execute as @e[type=minecraft:armor_stand,tag=thewheel,scores={wheel_anim=17,wheel_timer=101..}] at @s run summon minecraft:firework_rocket ~6 ~0.5 ~-2 {LifeTime:20,FireworksItem:{id:firework_rocket,Count:1,tag:{Fireworks:{Explosions:[{Type:0,Flicker:1b,Trail:1b,Colors:[I;16755200],FadeColors:[I;16777045]}]}}}}
execute as @e[type=minecraft:armor_stand,tag=thewheel,scores={wheel_anim=17,wheel_timer=101..}] at @s run summon minecraft:firework_rocket ~6 ~0.5 ~2 {LifeTime:20,FireworksItem:{id:firework_rocket,Count:1,tag:{Fireworks:{Explosions:[{Type:0,Flicker:1b,Trail:1b,Colors:[I;43520],FadeColors:[I;5635925]}]}}}}
execute as @e[type=minecraft:armor_stand,tag=thewheel,scores={wheel_anim=17,wheel_timer=101..}] at @s run summon minecraft:firework_rocket ~2 ~0.5 ~6 {LifeTime:20,FireworksItem:{id:firework_rocket,Count:1,tag:{Fireworks:{Explosions:[{Type:0,Flicker:1b,Trail:1b,Colors:[I;43520],FadeColors:[I;5635925]}]}}}}
execute as @e[type=minecraft:armor_stand,tag=thewheel,scores={wheel_anim=17,wheel_timer=101..}] at @s run summon minecraft:firework_rocket ~-2 ~0.5 ~6 {LifeTime:20,FireworksItem:{id:firework_rocket,Count:1,tag:{Fireworks:{Explosions:[{Type:0,Flicker:1b,Trail:1b,Colors:[I;11141120],FadeColors:[I;16733525]}]}}}}
execute as @e[type=minecraft:armor_stand,tag=thewheel,scores={wheel_anim=17,wheel_timer=101..}] at @s run summon minecraft:firework_rocket ~-6 ~0.5 ~-2 {LifeTime:20,FireworksItem:{id:firework_rocket,Count:1,tag:{Fireworks:{Explosions:[{Type:0,Flicker:1b,Trail:1b,Colors:[I;170],FadeColors:[I;5592575]}]}}}}
...
# Detect button
execute as @e[type=minecraft:armor_stand,tag=thewheel,scores={wheel_anim=0}] at @s if block ~ ~ ~ minecraft:stone_button[powered=true] if score @p wheel_xp <= $30 wheel_xp run tellraw @p ["",{"text":"\u300cTHE WHEEL\u300d ","bold":true},{"text":"The spin cost is ","color":"red"},{"text":"30 LEVELS","color":"dark_red"}]
execute as @e[type=minecraft:armor_stand,tag=thewheel,scores={wheel_anim=0}] at @s if block ~ ~ ~ minecraft:stone_button[powered=true] if score @p wheel_xp >= $30 wheel_xp run tag @p add wheeltarget
execute as @e[type=minecraft:armor_stand,tag=thewheel,scores={wheel_anim=0}] at @s if block ~ ~ ~ minecraft:stone_button[powered=true] if entity @p[tag=wheeltarget] run scoreboard players add @p[tag=wheeltarget] wheel_counter 1
execute as @e[type=minecraft:armor_stand,tag=thewheel,scores={wheel_anim=0}] at @s if block ~ ~ ~ minecraft:stone_button[powered=true] if entity @p[tag=wheeltarget] run xp add @p[tag=wheeltarget] -30 levels
execute as @e[type=minecraft:armor_stand,tag=thewheel,scores={wheel_anim=0}] at @s if block ~ ~ ~ minecraft:stone_button[powered=true] if entity @p[tag=wheeltarget] run tellraw @a ["",{"text":"\u300cTHE WHEEL\u300d ","bold":true},{"selector":"@p[tag=wheeltarget]","color":"dark_red"},{"text":" is spinning THE WHEEL","color":"red"}]
execute as @e[type=minecraft:armor_stand,tag=thewheel,scores={wheel_anim=0}] at @s if block ~ ~ ~ minecraft:stone_button[powered=true] if entity @p[tag=wheeltarget] run scoreboard players set @s wheel_timer 1
execute as @e[type=minecraft:armor_stand,tag=thewheel,scores={wheel_anim=0}] at @s if block ~ ~ ~ minecraft:stone_button[powered=true] if entity @p[tag=wheeltarget] run scoreboard players set @s wheel_anim 1
