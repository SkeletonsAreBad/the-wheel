...
execute as @e[type=minecraft:armor_stand,tag=thewheel,scores={wheel_anim=0,wheel_cooldown=0}] at @s if block ~ ~ ~ minecraft:stone_button[powered=true] if entity @p[tag=wheeltarget] run scoreboard players set @s wheel_timer 1
